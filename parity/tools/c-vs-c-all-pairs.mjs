 ...
 *
 * WHY IT LIVES HERE. It was moved out of this repository with the working
 * record (0264ae09c), which left task #150 unable to run its own first step
 * from a clean checkout - the tool that decides whether a finding is real is a
 * MEASUREMENT INSTRUMENT, not a record of past work, and belongs beside the
 * thing it measures. Restored 2026-08-11.
 *
 * WHAT IT DOES NOT MEASURE, which matters because #150 names this file as its
 * instrument: this computes the null for the FEELING histograms
 * (`obj_feelings`, `mon_feelings`) via a G-test. It does NOT compute the
 * OBJECT-COUNT Stouffer Z, which is the statistic that moved to -4.29 under
 * the 4.2.6 gamedata. Running this file as-is answers a different question.
 *
