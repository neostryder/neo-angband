...
| 8 | [Add a store](https://github.com/neostryder/neo-angband/blob/master/docs/modding/tutorials/08-add-a-store.md) | Turning a town storefront into your own shop, and adding one shop rule | 4 |
...
The [feature restoration](https://github.com/neostryder/neo-angband/blob/master/docs/modding/FEATURE_RESTORATION.md) idea in particular came
