...
/* ------------------------------------------------------------------ *
 * NO REACHABILITY PROMISE - deliberately.
 *
 ...
 * placement primitive above (placeStairs, squareIsEmpty, squareIsNoStairs,
 * squareNumWallsAdjacent) - so the repair needs nothing from core that a
 * third-party level mod would not also need. gen.test.ts' CONTROL test pins the
 * wart, and fails if the repair is ever moved back in here.
 * ------------------------------------------------------------------ */
