...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    port: [
      ...
      "gear.store[0][1].flagNames",
      "gear.store[0][1].modifierValues",
      "gear.store[0][1].brands",
      "gear.store[0][1].slays",
      "gear.store[0][1].curses",
      "gear.store[0][1].elementInfo",
  ...
  },
  {
    ...
    port: [
      ...
      "monsters[1].mspeed",
      "monsters[1].energy",
      "monsters[1].monsterTimed",
      "monsters[1].mflagNames",
      "monsters[1].knownPstateFlagNames",
      "monsters[1].knownPstateElementRes",
  ...
  },
  {
    ...
    port: [
      ...
      "player.ht",
      "player.wt",
      "player.statMaxValues",
      "player.statCurValues",
      "player.statMapNames",
      "player.statBirthValues",
      "player.htBirth",
      "player.wtBirth",
      "player.auBirth",
      "player.au",
  ...
  },
  {
    ...
    port: [
      ...
      "isDead",
      "turn",
      "player.objKnown.flagNames",
      "player.objKnown.modifierValues",
      "player.objKnown.elementInfo",
